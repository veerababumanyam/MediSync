-- AnySync AI Agent Core - Read-Only Role Permissions Update (Rollback)
-- Version: 009
-- Description: Revoke AI Agent Core specific permissions from AnySync_readonly role
-- Task: T012
--
...
-- 2. Verification view
--
-- Note: This does NOT drop the AnySync_readonly role itself, as it may be used
...
ALTER DEFAULT PRIVILEGES IN SCHEMA public REVOKE SELECT ON TABLES FROM AnySync_readonly;
