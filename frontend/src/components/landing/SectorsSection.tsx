    ...
    return (
        <section id="sectors" className="pt-24 mb-24 animate-fade-in-up delay-2" aria-labelledby="sectors-heading">
            <div className="text-center mb-12">
                <h2 id="sectors-heading" className={`text-3xl sm:text-4xl font-extrabold mb-5 ${isDark ? 'text-white' : 'text-slate-900'}`}>
                    {t('sectors.title', 'Dominating Complexity Across Every Healthcare Sector')}
                </h2>
                <p className={`text-base sm:text-lg max-w-3xl mx-auto leading-relaxed ${isDark ? 'text-slate-400' : 'text-slate-600'}`}>
