            ...
            <main className="max-w-6xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-12 sm:py-16 relative z-10 flex-grow">
                ...
                <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20 items-start">
                    ...
                    <FeatureCard
                        ...
                        gradientDark="from-purple-500/20 to-pink-400/20"
                        iconColorLight="text-purple-600"
                        iconColorDark="text-purple-400"
                        shadowLight="shadow-md shadow-purple-500/15"
                        borderLight="border-2 border-purple-200"
                        borderDark="border border-purple-500/20"
                    ...
                    <FeatureCard
                        ...
                        gradientDark="from-rose-500/20 to-red-400/20"
                        iconColorLight="text-rose-600"
                        iconColorDark="text-rose-400"
                        shadowLight="shadow-md shadow-rose-500/15"
                        borderLight="border-2 border-rose-200"
                        borderDark="border border-rose-500/20"
                ...
                <section className="mb-20 animate-fade-in-up delay-4">
