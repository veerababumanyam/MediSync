...
**Rules:**
- All AI agents MUST connect to the data warehouse using the `AnySync_readonly` database role
...
**Rules:**
- AI agents execute queries via `AnySync_readonly` role with GRANT SELECT only
...
Every component of the AnySync platform MUST use an OSI-approved license.
